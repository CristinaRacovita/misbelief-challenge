...
def evaluate_approaches():
    app_2 = pd.read_json("evaluation\evaluation_approach_2.json")
    app_3 = pd.read_json("evaluation\evaluation_approach_3.json")
    app_4 = pd.read_json("evaluation\evaluation_approach_4.json")
    app_5 = pd.read_json("evaluation\evaluation_approach_5.json")
